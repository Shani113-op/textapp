        ...
        <>
            <div>
                <div className="container mb-3" style={{color: props.mode==='dark'?'white':'black'}}>
                    <h1 >{props.heading}</h1>
                    <textarea className="form-control" id="myBox" value={text} style={{backgroundColor: props.mode==='dark'?'#12466e':'white',color: props.mode==='dark'?'white':'black'}} onChange={OnChange} rows="8"></textarea>
                ...
                <div className="container" style={{color: props.mode==='dark'?'white':'black'}}>
                    ...
                    <p><b>{text.split(" ").filter((element)=>{return element.length!==0}).length}</b> words <b>{text.length}</b> character</p>
